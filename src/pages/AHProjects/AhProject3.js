...
const AhProject3 = () => {
  ...
  return (
    <div className="xl:w-full relative bg-gray h-[2599px] overflow-hidden text-left text-xl text-cold-grey-white font-poppins
    w-[1207px] flex flex-col  items-start justify-start  py-0 px-5">
      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[632.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
            AI-Driven Heat Detection: Utilizes advanced algorithms for accurate analysis of behavioral and physiological indicators.
            ...
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Integration with Reproductive Management Software: Seamlessly integrates with existing software for enhanced decision-making and centralized data management.
          ...
          <div className="absolute top-[840.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul className="text-justify">
              <li>Increased Conception Rates: Improves reproductive management, leading to increased conception rates in dairy herds.</li>
              <li>Enhanced Data Management: Facilitates centralized data management through integration with existing software.</li>
              <li>Continuous Improvement: Establishes a feedback loop for iterative refinement, ensuring ongoing enhancements.</li>
              <li>Farmer Adoption: Promotes successful adoption through educational programs and farmer training sessions.</li>
          ...
          Automated Heat Detection in Dairy Cattle:<br />
            <div className="absolute top-[65px] text-13xl">  AI for Reproductive Management
            </div>
          </div>
      ...
      <div className="absolute top-[2181px] left-[calc(50%_-_720px)] bg-blue w-[1440px] h-[420px] text-sm font-roboto">
