      ...
      <section className="text-white flex flex-wrap  body-font md:mx-[95px] lg:mx-0">
        <div className="container px-24 py-24">
          ...
          <div className="container mx-auto pt-[350px] font-poppins">
            ...
            <p className="mt-4 mx-[-60px] md:mx-[-130px] lg:mx-[-100px] xl:mx-[-80px] pl-10 text-13xl md:text-xl lg:text-base text-white text-justify break-all">Agriculture research encompasses the systematic study, experimentation, and investigation conducted to enhance understanding and improve various aspects of agriculture. This include exploring new farming techniques, developing resilient crop varieties, optimizing livestock management, and addressing challenges to promote sustainable and efficient agriculture practices. It aims to overall agricultural productivity and also enhances efficiency, sustainability and resilience in the agriculture sector.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* contain/images */}
         ...
         <div className="container flex px-10 py-24 md:flex-row flex-col items-center"onClick={onGroupContainerClick}>
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-14 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center ">
            <h1 className="title-font mb-4 font-medium text-blue font-poppins md:w-[350px] text-29xl md:text-17xl lg:w-[500px] break-all"> Precision Agriculture: Integrating AI for Optimal Resource Management

            </h1>
            <p className="mb-8 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base break-all"> The research project, "Precision Agriculture: Integrating AI for Optimal Resource Management," delves into the synergy of artificial intelligence (AI) and precision agriculture to enhance resource efficiency, improve crop yields, and foster sustainable farming practices.
