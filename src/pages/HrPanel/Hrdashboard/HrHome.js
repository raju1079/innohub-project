...
import { fetchTotalStudents } from '../../../redux/actions/action'
import Calendar from './HrCalendar'
      ...
      <div className="p-8 mt-24 sm:ml-64 ">
        <div className="flex gap-10 px-10 pb-10 font-semibold max-md:flex-wrap">
          ...
          <div className="flex flex-auto gap-0 text-2xl font-medium tracking-wide text-center max-md:flex-wrap max-md:max-w-full">
            <div className="grow justify-center items-center px-10 pt-4 text-black  text-center bg-white rounded-l-lg h-[60px]  w-[250px] max-md:px-5">
              Admin portal
            </div>
