...
const HealthCare = () => {
  ...
  return (
    <div className="xl:w-full relative bg-gray h-[3210px] overflow-hidden text-left text-xl text-cold-grey-white font-poppins
  ...
  */}       </div>
      ...
      <div className="absolute w-full top-[90px] right-[0px] left-[0px] [background:linear-gradient(180deg,_#09011a,_rgba(105,_63,_196,_0.57)_43%,_rgba(163,_134,_223,_0)_91%)] h-[466px] overflow-hidden text-29xl">
        ...
        />
        <b className="absolute top-[303.6px] left-[calc(52%_-_624.1px)] capitalize">
          HealthCare
        </b>
      </div>
      <div className="absolute w-full top-[556px] right-[0px] left-[0px] h-[394px] overflow-hidden text-13xl">
        <div className="absolute top-[1.6px] left-[calc(50%_-_599.9px)] w-[1199.7px] h-[330.8px]">
          ...
          <div className="absolute top-[1.8px] left-[calc(50%_-_599.85px)] text-base text-justify inline-block w-[1199.7px] h-[261px]">
        ...
        <div className="absolute top-[120px] left-[calc(50%_-_597.4px)] w-[1194.8px] h-[1111px]">
          ...
          >
            ...
            <div className="absolute top-[51.1px] left-[calc(50%_-_4.2px)] w-[601.6px] h-[334.6px]">
              ...
              <div className="absolute top-[233.8px] left-[calc(50%_-_300.8px)] text-mini leading-[150%] text-cold-grey-white inline-block w-[601.6px] h-[150.7px] text-justify">
          ...
          <div className="absolute top-[594.6px] left-[calc(50%_-_597.4px)] w-[1194.8px] h-[516.4px] text-8xl">
            <div className="absolute top-[0px] left-[calc(50%_+_46.1px)] w-[551.3px] h-[516.4px]" onClick={onProject2Click}>
              <div className="absolute top-[0px] left-[calc(50%_-_275.65px)] rounded-lg bg-blue w-[270.8px] h-[378.3px]" />
              <div className="absolute top-[33.5px] left-[calc(50%_-_242.15px)] rounded-lg bg-white w-[517.8px] h-[482.9px] cursor-pointer" />
              <img
      ...
      <div className="flex flex-col sm:w-50 lg:w-50  flex-wrap justify-center w-full font-poppins ">
        <div className="absolute top-[2200px] left-[calc(60%_-_710px)] text-sm font-roboto shadow-md ">
          <div className=" absolute h-[400px] w-[250px] bg-blue rounded-xl ">
            <div className="mt-6 m-5 w-[350px] h-[350px] bg-white rounded-xl overflow-hidden">
              ...
              <div className="pt-0 mt-7 text-center">
                <button className="absolute  w-[100px] h-[30px] text-white bg-blue  text:align-center left-[220px] rounded-xl hover:bg-indigo-600 hover:text-black cursor-pointer" onClick={onProject3Click}>Read more</button>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute top-[2200px] left-[calc(53%_-_222px)] text-sm font-roboto">
          <div className=" absolute h-[400px] w-[350px] bg-blue rounded-xl g ">
            <div className="mt-6 w-[350px] h-[350px] bg-white rounded-xl overflow-hidden">
              ...
              <button className="absolute mt-14 w-[100px] h-[30px] text-white bg-blue  text:align-center left-[220px] rounded-xl hover:bg-indigo-600 hover:text-black cursor-pointer" onClick={onProject4Click}>Read more</button>
            </div>
          </div>
        </div>

        <div className="absolute top-[2200px] left-[calc(55%_-_-260px)]  text-sm font-roboto">
          <div className=" absolute h-[400px] w-[270px] bg-blue rounded-xl g ">
            <div className="mt-6  ml-[-100px] w-[350px] h-[350px] bg-white rounded-xl overflow-hidden">
              ...
              <button className="absolute  w-[100px] h-[30px] text-white bg-blue  text:align-center left-[130px] rounded-xl hover:bg-indigo-600 hover:text-black cursor-pointer" onClick={onProject5Click}>Read more</button>
            </div>
          </div>
        </div>
      </div>
