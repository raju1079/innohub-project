      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[702.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
            	Automated Code Analysis: Utilizes AI algorithms to automatically analyze code for quality, security, and adherence to coding standards.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
          ...
          <div className="absolute top-[360.3px] left-[calc(50%_-_609.7px)] text-13xl leading-[140%] capitalize font-semibold">
            AI Tool Name: CodeGuardian
          </div>
          <div className="absolute top-[445.6px] left-[calc(50%_-_609.7px)] text-5xl leading-[140%] capitalize font-semibold">
            Objective:
          </div>
          ...
          <div className="absolute top-[1125.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul className="text-justify">
              ...
              <li>•	DevOps Teams: Providing a valuable tool for DevOps teams looking to integrate automated code review seamlessly into their workflows.</li>
              <li>•	Enterprise Solutions: Offering enterprise-level solutions for organizations with complex and large-scale software projects.</li>
            </ul>
            <p className="m-0">&nbsp;</p>
            <p className="m-0 text-5xl text-blue leading-[140%] capitalize font-semibold">
              Project Impact:
            ...
            <ul className="text-justify">
              <li>	Improved Code Quality: Enhances code quality by automating the identification of issues and suggesting improvements.</li>
              <li>Efficient Development Processes: Streamlines the code review process, leading to more efficient development cycles.</li>
              <li>	Security Enhancement: Identifies security vulnerabilities in the code, contributing to a more secure software development lifecycle.</li>
              <li>Time and Cost Savings: Reduces the time and costs associated with manual code review, allowing developers to focus on critical tasks.</li>
          ...
          Automated Code Review with Artificial Intelligence: <br />
            <div className=" absolute top-[105px] text-13xl"> Improving Code Quality and Development Efficiency </div>

          </div>
          <div className="absolute top-[214.2px] left-[calc(50%_-_609.7px)] text-mini leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[518.6px] text-justify">
            <p className="m-0">
