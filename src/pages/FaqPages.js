     ...
     {/* <div className="relative bg-gray md:w-full w-[739px] p-0 mx-full]"> */}
      <div className=" mx-auto pt-[5px] font-poppins ">
        ...
        <div className="container mx-auto pt-[200px] md:pt-[250px] font-poppins ">
          <b className=" mb-10 m-5 mt-[40px] ml-[40px] text-29xl  md:text-29xl m-5 font-semi-bold text-white flex content-center items-center "> Frequently Asked Questions </b>
          {currentQuestions.map((faq, index) => (
            <div key={index} className="mt-4">
              ...
              {selectedOption === index && (
                <p className="mt-[40px] ml-[75px] leading-relaxed text-cold-grey-white text-justify-center font-poppins hover:underline text-13xl md:text-13xl lg:text-xl transform scale-120">
                  {faq.answer}
                </p>
              )}
            </div>
