  ...
  return (
    <div className="relative bg-gray md:w-full w-[739px] p-0 mx-full">
      ...
      <div className="container mx-auto pt-[300px] font-poppins ">
        ...
        <p className="mb-10 m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl md:mb-5 lg:mb-5 xl:mb-5 lg:text-base break-all">The InnoHub Research Centre, established in 2017 as SNIPE TECH PVT LTD
        ...
        <p className="mb-10 m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl md:mb-5 lg:mb-5 xl:mb-5 lg:text-base break-all"> Over the years, our commitment to excellence has attracted top-tier
      ...
      <div className="mb-10 pt-10 mt-10 ml-10 w-[650px] h-auto md:w-[750px] md:ml-[220px] lg:w-[1050px] lg:ml-[130px] xl:w-[1200px] xl:ml-[80px] bg-blueviolet [backdrop-filter:blur(25px)] rounded-xl">
        ...
        <p className=" p-8 pb-[70px] m-2 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl lg:text-base break-all">
      ...
      <div className="mb-[200px] pt-10 mt-10 ml-10 w-[650px] h-auto md:w-[750px] md:ml-[220px] lg:w-[1050px] lg:ml-[130px] xl:w-[1200px] xl:ml-[80px] bg-blueviolet [backdrop-filter:blur(25px)] rounded-xl">
        ...
        <p className=" p-8 m-2 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl lg:text-base break-all">
        ...
        <ul className="mb-[150px] m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base break-all ">
