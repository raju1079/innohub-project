  ...
  return (
    <div className="relative bg-gray md:w-full w-[739px] p-0 mx-full">
      ...
      <div className="container mx-auto pt-[300px] font-poppins ">
        ...
        <p className="mb-5 m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base transform scale-120">  IntelliLearn Assist is designed to revolutionize education by focusing on early intervention for learning disabilities detection through AI-driven data profiling. It encompasses the analysis of academic performance, behaviour patterns, and cognitive assessments to construct comprehensive learning profiles for individual Students.
        </p>
        <h3 className="text-29xl lg:text-17xl text-blue m-5" >
          Target Audience:</h3>
        <p className=" m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base transform scale-120">Educational institutions, teachers, educational specialists, and students across various levels.
        </p>
