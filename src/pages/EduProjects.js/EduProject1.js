...
const EduProject1 = () => {
  ...
  return (
    <div className="relative bg-gray xl:w-full md:w-[1030px] w-[750px] px-0 md:px-0 mx-auto">
       <Header />
      ...
      <div className="container mx-auto pt-[300px] font-poppins ">
        ...
        <p className="mt-4 text-sm m-5 md:text-xl lg:mx-10 text-white text-justify ">
        ...
        <h2 className="text-17xl text-blue m-5" >AI Tool Name: EduAImentor</h2>
        <h3 className="text-13xl text-blue m-5" >Objective:</h3>

        <p className="mt-4 text-sm md:text-xl lg:mx-10 m-5 text-white text-justify ">  The primary goal of this project is to develop and implement an artificial intelligence-based tool, EduAImentor, that enhances personalized learning experiences for students, thereby optimizing their engagement in educational settings. The tool aims to cater to the diverse needs of both educators and students, offering adaptive learning paths, real-time feedback, and data-driven insights to improve overall academic outcomes.
        </p>

        <h3 className="text-13xl text-blue m-5" >Key Features:</h3>
        <ul className="text-sm md:text-xl lg:mx-10 m-5 text-white text-justify ">
        ...
        <h3 className="text-13xl text-blue m-5" >Project Impact:</h3>
        <ul className="text-sm md:text-xl lg:mx-10 m-5 text-white text-justify">
