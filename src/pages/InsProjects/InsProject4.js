      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[592.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
              Collaborative Model Analysis: Utilizes AI to analyze existing
              collaborative models, identifying patterns and successful
              strategies.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Patient Outcome Assessment: Incorporates machine learning to
              assess the influence of collaborative models on patient outcomes,
              including treatment efficacy and cost-effectiveness.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Policy Framework Evaluation: Performs a detailed analysis of
          ...
          <div className="absolute top-[830.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul className="text-justify">
              <li>
                The target audience includes healthcare professionals, insurance
            ...
            <ul className="text-justify">
              <li>
                The tool aims to provide actionable insights into fostering
 ...
 */}{" "}
          ...
          Hospitals as Stakeholders: <br />
            <div className="absolute top-[65px] text-13xl">
              {" "}
              Exploring the Role and Impact of Healthcare Institutions in Insurance </div>
          </div>
