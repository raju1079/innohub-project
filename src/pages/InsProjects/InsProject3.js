      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[592.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
              Trend Analysis: Utilizes machine learning algorithms to analyze
              industry trends, digital disruption, and customer preferences,
              identifying key areas for adaptation.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Customer-Centric Metrics: Measures and evaluates customer-centric
              metrics to help insurance firms align their services with evolving
              customer expectations.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Technology Adoption Assessment: Assesses the adoption of emerging
          ...
          <div className="absolute top-[850.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul className="text-justify">
              <li>
                The primary target audience for "InsureInsight AI" includes
            ...
            <ul className="text-justify">
              <li>
                The tool aims to empower insurance firms with valuable insights,
 ...
 */}{" "}
          ...
          Transformative Trends in Insurance Firms: <br />
            <div className="absolute top-[65px] text-13xl">
              {" "}
              Adapting to Digital Disruption and Customer-Centric Models</div>
          </div>
