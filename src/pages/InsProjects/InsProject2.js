...
const InsProject2 = () => {
  ...
  return (
    <div
      className="xl:w-full relative bg-gray h-[2624px] overflow-hidden text-left text-xl text-cold-grey-white font-poppins
    ...
    >
      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[408.4px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[114.6px] text-justify">
            The "CorpInsureOptimize" AI tool is developed to comprehensively
            address the efficiency of corporate insurance processes. It focuses
            on two key aspects: risk mitigation and cost optimization. The tool
            delves into innovative approaches and technologies that can be
            employed by corporations to streamline risk management, ultimately
            leading to more efficient and cost-effective corporate insurance
            solutions
          </div>
          <div className="absolute top-[592.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
              Risk Assessment Models: Incorporates advanced AI-driven risk
          ...
          <div className="absolute top-[270.3px] left-[calc(50%_-_609.7px)] text-13xl leading-[140%] capitalize font-semibold">
            AI Tool Name:CorpInsureOptimize
          </div>
          <div className="absolute top-[345.6px] left-[calc(50%_-_609.7px)] text-5xl leading-[140%] capitalize font-semibold">
            Objective:
          </div>
          <div className="absolute top-[532.5px] left-[calc(50%_-_609.7px)] text-5xl leading-[140%] capitalize font-semibold">
            Key Features:
          </div>
          <div className="absolute top-[830.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul className="text-justify">
              <li>
                Corporate Risk Managers: "CorpInsureOptimize" is designed for
            ...
            <ul className="text-justify">
              <li>
                The research project aims to have a substantial impact on
 ...
 */}{" "}
          ...
          Corporate Insurance Efficiency:<br />
