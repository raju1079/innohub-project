    ...
    w-[1207px] flex flex-col  items-start justify-start  py-0 px-5">
      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[458.4px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[114.6px] text-justify">
            Scope of the Tool: TeleHealthAI encompasses a comprehensive suite of AI-driven functionalities to facilitate remote patient monitoring. It covers smart wearables integration, predictive analytics, diagnostic assistance, patient engagement through chatbots, risk stratification, EHR interoperability, continuous learning, and ethical considerations.</div>
          <div className="absolute top-[682.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
              Real-time Monitoring: AI-enabled analysis of vital signs and health metrics from smart wearables and IoT devices for continuous, real-time patient monitoring.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Predictive Health Trends: Utilize predictive analytics to identify health trends and potential risks, allowing timely intervention.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              AI-assisted Diagnostics: Enhance remote diagnostics through AI analyzing medical images, symptoms, and relevant data, aiding accurate telemedicine consultations.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Chatbot-Patient Engagement: Implement AI-powered chatbots for personalized communication, education, and health monitoring, fostering improved patient adherence.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Risk Stratification: Utilize AI to stratify patients based on risk levels, prioritizing interventions for those at higher risk.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              EHR Interoperability: Ensure seamless information exchange by integrating AI-enabled remote patient monitoring with electronic health records.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
          ...
          <div className="absolute top-[300.3px] left-[calc(50%_-_609.7px)] text-13xl leading-[140%] capitalize font-semibold">
            AI Tool Name: PharmaDiscoverAI
          </div>
          <div className="absolute top-[385.6px] left-[calc(50%_-_609.7px)] text-5xl leading-[140%] capitalize font-semibold">
            Objective:
          </div>
          <div className="absolute top-[592.5px] left-[calc(50%_-_609.7px)] text-5xl leading-[140%] capitalize font-semibold">
            Key Features:
          </div>
          <div className="absolute top-[1130.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            <p className="m-0  text-5xl text-blue leading-[140%] capitalize font-semibold">
              Target Audience:
            </p>

            <ul className="text-justify">
              <li>Healthcare Providers: Doctors, nurses, and healthcare professionals involved in telemedicine.
              </li>
              <li>Patients: Individuals seeking remote healthcare monitoring, especially those with chronic conditions.

              </li>
              <li>Telehealth Platforms: Organizations providing telemedicine services.
              </li>
            </ul>
            <p className="m-0">&nbsp;</p>
            <p className="m-0 text-5xl text-blue leading-[140%] capitalize font-semibold">
            ...
            <ul className="text-justify">
              <li>	Improved Virtual Care Quality: Enhance the quality of remote patient care through AI-driven continuous monitoring and diagnostics.
                
          
              </li>
              <li>	Enhanced Patient Engagement: Improve patient adherence and engagement through personalized interactions and education via chatbots.
              </li>
              <li>	Risk-based Prioritization: Prioritize interventions effectively by stratifying patients based on risk levels.</li>
              <li>Seamless Information Exchange: Facilitate comprehensive virtual consultations with EHR integration and interoperability.
              </li>
              <li>Adaptability and Learning: Ensure the tool evolves with technological advancements and changing patient data.</li>
          ...
          Telemedicine Transformation:<br />
              <div className=" absolute top-[65px] text-13xl">AI-Enabled Remote Patient Monitoring
            </div>      </div>
