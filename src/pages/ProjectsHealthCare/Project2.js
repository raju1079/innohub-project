  ...
  return (
    <div className="relative bg-gray md:w-full w-[739px] p-0 mx-full">
      ...
      <div className="container mx-auto pt-[300px] font-poppins ">
        ...
        <p className="mb-5 m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base break-all">  The PharmaDiscoverAI tool aims to revolutionize the drug discovery process by integrating artificial intelligence across key stages, including target identification, compound screening, and predictive modeling. It encompasses automation and optimization features to streamline pharmaceutical innovations.
        </p>
