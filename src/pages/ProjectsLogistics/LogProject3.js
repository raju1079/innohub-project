  ...
  return (
    <div className="relative bg-gray md:w-full w-[739px] p-0 mx-full">
      ...
      <div className="container mx-auto pt-[300px] font-poppins ">
        ...
        <p className="mb-[200px] m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base break-all">EcoLogiSense stands as a comprehensive tool facilitating the adoption of sustainable practices in logistics. Through its features, it contributes to reducing environmental impact, fostering collaboration, influencing policies, and promoting knowledge dissemination for a greener logistics ecosystem.
        </p>
      </div>
      <Footer />
    </div>
