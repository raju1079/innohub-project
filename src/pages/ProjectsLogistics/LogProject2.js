        ...
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[532.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            <p className="m-0">
            	...
            	Robust Blockchain Architecture: Ensures scalability, security, and interoperability.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            IoT Integration: Captures real-time data from the physical supply chain for transparency.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Traceability and Provenance: Records product movements and ensures authenticity.


            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Smart Contracts Automation: Streamlines processes and enforces contractual agreements.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Secure Data Sharing: Facilitates transparent collaboration among stakeholders.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Interoperability: Seamless integration with existing supply chain management systems.

            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            Real-World Pilot Implementations: Practical assessments of blockchain feasibility in specific supply chain segments.
          ...
          <div className="absolute top-[890.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul>
              <li>	Supply Chain Managers: Seeking transparency, traceability, and efficiency improvements.</li>
              <li>	Logistics Companies: Enhancing operational integrity and reducing fraud in logistics.
              </li>
              <li>	Regulatory Bodies: Establishing standards for blockchain implementation in logistics.</li>
            </ul>
            <p className="m-0">&nbsp;</p>
            <p className="m-0 text-5xl text-blue leading-[140%] capitalize font-semibold">
              Project Impact:
            ...
            <ul>
              <li>Enhanced Efficiency: Improved transparency leading to streamlined logistics processes.

              </li>
              <li>	Reduced Fraud: Blockchain's immutability reduces the risk of fraudulent activities.
              </li>
              <li>	Increased Trust: Transparent and traceable supply chain builds trust among stakeholders.

              </li>
              <li>	Interoperability: Seamless integration with existing systems encourages widespread adoption.

              </li>
              <li>	Educational Outreach: Increased awareness and understanding of blockchain benefits.</li>
            </ul>
