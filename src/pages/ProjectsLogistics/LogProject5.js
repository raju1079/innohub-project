      ...
      <div className="absolute w-full top-[520px] right-[0px] left-[0px] h-[2682px] overflow-hidden text-base text-blue">
        <div className="absolute top-[68.6px] left-[calc(50%_-_609.7px)] w-[1219.4px] h-[2544.8px]">
          ...
          <div className="absolute top-[398.4px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[114.6px] text-justify">
            DroneOptiLog encompasses features for regulatory compliance tracking, technological advancement integration, cost-benefit modeling, customer sentiment analysis, environmental impact assessment, and operational challenge mitigation.</div>
          <div className="absolute top-[532.7px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px] text-justify">
            <p className="m-0">
              ...
              Regulatory Compliance Tracker: Monitors and updates users on evolving drone-related regulations and ensures adherence.
            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            ...
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Cost-Benefit Calculator: Conducts a detailed economic analysis, comparing drone delivery costs with traditional methods.            </p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Customer Sentiment Analyzer: Gathers and analyzes public sentiment regarding drone deliveries to gauge acceptance factors.</p>
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
            ...
            <p className="m-0">&nbsp;</p>
            <p className="m-0">
              Operational Challenge Module: Identifies potential challenges and offers mitigation strategies for smooth drone operations.
            </p>
          </div>
          ...
          <div className="absolute top-[890.9px] left-[calc(50%_-_609.7px)] leading-[150%] text-cold-grey-white inline-block w-[1195.4px] h-[432.8px]">
            ...
            <ul>
              <li>			Logistics Executives


              </li>
              <li>		Drone Technology Developers

              </li>
              <li>		Regulatory Authorities

              </li>
              <li>	Environmental Agencies

              </li>
              <li>	Last-Mile Delivery Service Providers
            ...
            <ul className="text-justify">
              <li>			Enhanced Efficiency: Reduces delivery times and optimizes last-mile logistics processes.

              </li>
              <li>		Economic Feasibility: Provides a tool for decision-makers to assess the economic viability of implementing drone deliveries.
              </li>
              <li>			Customer Acceptance: Offers insights into customer perceptions, aiding in the development of strategies to increase acceptance.
              </li>
              <li>		Environmental Sustainability: Quantifies and compares the environmental impact of drone and traditional deliveries.
              </li>
              <li>			Operational Resilience: Identifies challenges and proposes mitigation strategies for a seamless drone delivery experience.
              </li>
            </ul>
 ...
 */}          </div>
          ...
          Drones in Logistics:<br />
              <div className="absolute top-[65px] text-13xl"> Exploring the Potential for Last-Mile Deliveries</div> 
          </div>
