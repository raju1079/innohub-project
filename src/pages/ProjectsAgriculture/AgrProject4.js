  ...
  return (
    <div className="relative bg-gray md:w-full w-[739px] p-0 mx-full">
      ...
      <div className="container mx-auto pt-[300px] font-poppins ">
        ...
        <p className="mb-5 m-5 leading-relaxed text-cold-grey-white text-justify font-poppins text-13xl md:text-xl  lg:text-base break-all"> SoilIntel Pro covers a comprehensive suite of AI-driven features for soil health assessment, catering to various aspects of sustainable agriculture.
