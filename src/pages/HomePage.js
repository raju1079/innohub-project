...
const HomePage = () => {
  ...
  <div className="xl:w-full relative bg-gray h-[3376px] overflow-hidden text-left text-xl text-cold-grey-white font-poppins
    w-[1207px] flex flex-col  items-start justify-start  py-0 px-5">
      ...
      <div className="absolute top-[1129.8px] left-[calc(50%_-_719.1px)] w-[1440px] h-[212px] overflow-hidden text-17xl">
        <b className="absolute top-[26.2px] left-[calc(50%_-_598px)] capitalize inline-block w-[407.2px] h-[54px]">
          Our Key Focus Areas:
        </b>
      ...
      <div className="absolute top-[1291.8px] left-[calc(50%_-_719.1px)] w-[1440px] h-[1391px] overflow-hidden text-13xl text-blue">
        <img
