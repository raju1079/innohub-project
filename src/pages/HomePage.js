...
const HomePage = () => {
  ...
  return (
    <div className="w-full relative bg-gray h-[3678px] overflow-hidden text-left text-xl text-cold-grey-white font-poppins">
      ...
      <div className="absolute w-[calc(100%_-_3px)] top-[90px] right-[1.6px] left-[1.4px] [background:linear-gradient(180deg,_#09011a,_rgba(105,_63,_196,_0.57)_43%,_rgba(163,_134,_223,_0)_91%)] h-[711px] overflow-hidden text-29xl">
        ...
        <img
          className="absolute top-[0px] left-[calc(50%_-_721.4px)] w-[1442.8px] h-[493.5px] object-cover object-fit: none;"
          alt=""
        ...
        />
        <div className="absolute top-[293.6px] left-[calc(53%_-_624.1px)] capitalize inline-block w-[524.2px] h-[191.8px]">
          <p className="m-0">
            <b>Explore the World of Innovative</b>
          </p>
          <p className="m-0 text-13xl font-medium">{` `}</p>
        </div>
        <div className="absolute top-[453.6px] left-[calc(53%_-_624.1px)] capitalize font-medium text-thistle inline-block w-[797.4px] h-[191.8px] text-13xl">
     ...
     {/*  <ScrollingText/> */}
        ...
        <div className="absolute top-[69.4px] left-[calc(50%_-_602.8px)] w-[1193.9px] h-[495.1px]">
          <b className="absolute top-[0px] left-[calc(51%_-_594.55px)] capitalize inline-block w-[763.2px] h-[80.2px]">
            Welcome to UPL research center
          </b>
          <div className="absolute top-[80.2px] left-[calc(50%_-_596.95px)] text-5xl capitalize inline-block w-[1193.9px] h-[414.8px]">
            <p className="m-0">
      ...
      <div className="absolute top-[1379.8px] left-[calc(50%_-_719.1px)] w-[1440px] h-[212px] overflow-hidden text-17xl">
        <b className="absolute top-[26.2px] left-[calc(51%_-_598px)] capitalize inline-block w-[407.2px] h-[54px]">
          Our Key Focus Areas:
        </b>
        <div className="absolute top-[106.4px] left-[calc(50%_-_599.7px)] capitalize inline-block w-[1197.7px] h-[67.1px] text-xl">
          <p className="m-0">
      ...
      <div className="absolute top-[1591.8px] left-[calc(50%_-_719.1px)] w-[1440px] h-[1391px] overflow-hidden text-13xl text-blue">
        <img
          className="absolute top-[3.9px] left-[465.9px] w-[1066.1px] h-[1386.7px] object-contain"
          alt=""
        ...
        <img
          ...
          src="/artboard-44x-3@2x.png"
        />
        <div className="absolute top-[73px] left-[767px] w-[546px] h-[1042px] flex flex-col items-start justify-between">
        ...
        <div className="absolute top-[262px] left-[122px] h-[1035px] flex flex-col items-start justify-between">
          <div className="w-[546px] relative rounded-xl h-64 overflow-hidden shrink-0 bg-[url('/public/frame-17@3x.png')] bg-cover bg-no-repeat bg-[top]">
            <div className="absolute w-[calc(100%_+_19px)] top-[-0.5px] right-[-19px] left-[0px] rounded-t-xl rounded-b-none bg-cold-grey-white shadow-[0px_7px_10px_rgba(0,_0,_0,_0.25)] h-[60px] overflow-hidden">
              <b className="absolute top-[6px] left-[22.5px]">
                {" "}
          ...
          <div className="w-[546px] relative rounded-xl h-64 overflow-hidden shrink-0 bg-[url('/public/frame-17@3x.png')] bg-cover bg-no-repeat bg-[top]">
            ...
            <div className="absolute top-[84.7px] left-[166.6px] text-xl text-cold-grey-white inline-block w-[379.3px]">
              ...
              flexible, and reliable solutions in the cloud.Collaborate,
              Innovate, Transform
            </div>
            <img
      ...
      <div className="absolute top-[2982.8px] left-[calc(50%_-_719.1px)] w-[1440px] h-[275px] overflow-hidden">
        <div className="absolute top-[23.1px] left-[120.3px] capitalize inline-block w-[1197.7px] h-[216px]">
          <p className="m-0">
          ...
          <p className="m-0 text-5xl font-semibold">Mallikarjuna G D</p>
          <p className="m-0">Director, UPL Research Center</p>
        </div>
      </div>
      <div className="absolute top-[3257.8px] left-[calc(50%_-_719.1px)] bg-blue w-[1440px] h-[420px] text-sm font-roboto">
